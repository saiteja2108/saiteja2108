...
class Ludo:
    def __init__(self, root: object, six_side_block: object, five_side_block: object, four_side_block: object, three_side_block: object, two_side_block: object,
                 one_side_block: object) -> object:
        self.window = root
        # Make canvas
    ...
    def take_initial_control(self) -> object:
        for i in range(4):
        ...
        top.iconbitmap("C:\Program Files\JetBrains\PyCharm Community Edition 2018.2.8\\ludo_icon.ico")

        head = Label(top, text="-:Total number of players:- ", font=("Arial", 25, "bold", "italic"), bg="#141414",
                     fg="chocolate")
        ...
        mvc_btn = Button(top, text="Play With Computer", bg="#262626", fg="#00FF00", font=("Arial", 15, "bold"),
                         relief=RAISED, bd=3, command=lambda: operate(1), activebackground="#262626")
    ...
    def instruction_btn_red(self):
        ...
        predict_red = Button(self.make_canvas, bg="black", fg="#00FF00", relief=RAISED, bd=5, text="Predict",
    ...
    def instruction_btn_sky_blue(self):
        ...
        predict_sky_blue = Button(self.make_canvas, bg="black", fg="#00FF00", relief=RAISED, bd=5, text="Predict",
    ...
    def instruction_btn_yellow(self):
        ...
        predict_yellow = Button(self.make_canvas, bg="black", fg="#00FF00", relief=RAISED, bd=5, text="Predict",
                                font=("Arial", 8, "bold"), command=lambda: self.make_prediction("yellow"))
        predict_yellow.place(x=100 + (40 * 6 + 40 * 3 + 40 * 6 + 2) + 20, y=15 + (40 * 6 + 40 * 3) + 40 + 20)

        btn_1 = Button(self.make_canvas, bg="#262626", fg="#00eb00", text="1", font=("Arial", 13, "bold", "italic"),
                       relief=RAISED, bd=3, command=lambda: self.main_controller("yellow", '1'), state=DISABLED,
                       disabledforeground="red")
        btn_1.place(x=100 + (40 * 6 + 40 * 3 + 40 * 6 + 2) + 15, y=15 + (40 * 6 + 40 * 3) + 40 + 70)
        btn_2 = Button(self.make_canvas, bg="#262626", fg="#00eb00", text="2", font=("Arial", 13, "bold", "italic"),
                       relief=RAISED, bd=3, command=lambda: self.main_controller("yellow", '2'), state=DISABLED,
                       disabledforeground="red")
        btn_2.place(x=100 + (40 * 6 + 40 * 3 + 40 * 6 + 2) + 15 + 40, y=15 + (40 * 6 + 40 * 3) + 40 + 70)
        btn_3 = Button(self.make_canvas, bg="#262626", fg="#00eb00", text="3", font=("Arial", 13, "bold", "italic"),
                       relief=RAISED, bd=3, command=lambda: self.main_controller("yellow", '3'), state=DISABLED,
                       disabledforeground="red")
        btn_3.place(x=100 + (40 * 6 + 40 * 3 + 40 * 6 + 2) + 15, y=15 + (40 * 6 + 40 * 3) + 40 + 70 + 40)
        btn_4 = Button(self.make_canvas, bg="#262626", fg="#00eb00", text="4", font=("Arial", 13, "bold", "italic"),
                       relief=RAISED, bd=3, command=lambda: self.main_controller("yellow", '4'), state=DISABLED,
                       disabledforeground="red")
        btn_4.place(x=100 + (40 * 6 + 40 * 3 + 40 * 6 + 2) + 15 + 40, y=15 + (40 * 6 + 40 * 3) + 40 + 70 + 40)

        Label(self.make_canvas, text="Player 3", bg="#141414", fg="gold", font=("Arial", 15, "bold")).place(
            x=100 + (40 * 6 + 40 * 3 + 40 * 6 + 7), y=15 + (40 * 6 + 40 * 3) + 40 + 110 + 50)
    ...
    def instruction_btn_green(self):
        ...
        predict_green = Button(self.make_canvas, bg="black", fg="#00FF00", relief=RAISED, bd=5, text="Predict",
            ...
            if self.move_yellow_counter == 106:
                ...
                if self.yellow_coin_position[int(coin_number) - 1] + self.move_yellow_counter <= 106:
                    self.yellow_coin_position[int(coin_number) - 1] = self.motion_of_coin(
                        self.yellow_coin_position[int(coin_number) - 1], self.made_yellow_coin[int(coin_number) - 1],
                        self.yellow_number_label[int(coin_number) - 1], yellow_start_label_x, yellow_start_label_y,
                ...
                if len(self.robo_store) == 1:  # When only one coin is outside of the room
                    ...
                    def normal_movement_according_condition():
                        ...
                        for coin in self.robo_store:  # coin is coin number
                            if temp[
                                coin - 1] + self.move_red_counter <= 106:  # For all coins having predicted location <=106
                                pass
                            else:
                                normal_movement = 0
                                break
                        ...
                        for coin in temp_robo_store:  # coin is coin number
                            if len(temp_robo_store) > 1 and temp[
                                coin - 1] < 101:  # See Diagram under help to unserstand to understand the location
                                ...
                                for robo in temp_robo_store:  # robo is coin number
                                    for coin_other in take_ref:  # coin_other is sky_blue coin location
                                        if coin_other > -1 and coin_other < 100:
                                            if take_len > 1 and (temp[robo - 1] > 38 and coin_other <= 38) or ((temp[
                                                                                                                    robo - 1] == 9 or
                                                                                                                temp[
                                                                                                                    robo - 1] == 14 or
                                                                                                                temp[
                                                                                                                    ...
                                                                                                                    robo - 1] == 22) and (
                                                                                                                       ...
                                                                                                                       temp[
                                                                                                                           robo - 1] or (
                                                                                                                               coin_other >
                                                                                                                               temp[
                                                                                                                                   robo - 1] and coin_other <=
                                                                                                                               temp[
                                                                                                                                   robo - 1] + 3))):  # avoid case to store
                                                take_len -= 1
                                            else:
                                                store[temp[robo - 1] - coin_other] = (
                                                robo, take_ref.index(coin_other) + 1)  # Store coin number
...
if __name__ == '__main__':
    ...
    window.iconbitmap("C:\Program Files\JetBrains\PyCharm Community Edition 2018.2.8\ludo_icon.ico")
    block_six_side = ImageTk.PhotoImage(Image.open("C:\Program Files\JetBrains\PyCharm Community Edition 2018.2.8\\6_block.png").resize((33, 33), Image.ANTIALIAS))
    block_five_side = ImageTk.PhotoImage(Image.open("C:\Program Files\JetBrains\PyCharm Community Edition 2018.2.8\\5_block.png").resize((33, 33), Image.ANTIALIAS))
    block_four_side = ImageTk.PhotoImage(Image.open("C:\Program Files\JetBrains\PyCharm Community Edition 2018.2.8\\4_block.png").resize((33, 33), Image.ANTIALIAS))
    block_three_side = ImageTk.PhotoImage(Image.open("C:\Program Files\JetBrains\PyCharm Community Edition 2018.2.8\\3_block.png").resize((33, 33), Image.ANTIALIAS))
    block_two_side = ImageTk.PhotoImage(Image.open("C:\Program Files\JetBrains\PyCharm Community Edition 2018.2.8\\2_block.png").resize((33, 33), Image.ANTIALIAS))
    block_one_side = ImageTk.PhotoImage(Image.open("C:\Program Files\JetBrains\PyCharm Community Edition 2018.2.8\\1_block.png").resize((33, 33), Image.ANTIALIAS))
